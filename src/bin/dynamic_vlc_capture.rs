...
//! ApplicationSelector, AudioSourceDiscovery, ApplicationCapture, ApplicationCaptureFactory).
//! It needs to be rewritten to use the new AudioCaptureBuilder → AudioCapture → CapturingStream
//! pipeline.
//!
